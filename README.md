...
> [!TIP]
> If you are accessing a local Liferay instance through localhost and have issues with getting the configuration to connect, using "http://127.0.0.1:8080" might solve the connection issue. Some nodejs or axios versions have known issues for calling localhost.
